...
* [`org.graphity`](https://github.com/Graphity/graphity-browser/tree/master/src/main/java/org/graphity): Classes shared by all Graphity applications
    ...
    * [`org.graphity.browser`](https://github.com/Graphity/graphity-browser/tree/master/src/main/java/org/graphity/browser): Classes shared by all Graphity Browser applications
        ...
        * [`org.graphity.browser.SPARQLResource`](https://github.com/Graphity/graphity-browser/blob/master/src/main/java/org/graphity/browser/SPARQLResource.java): JAX-RS Resource for SPARQL endpoint/editor
        * [`org.graphity.browser.SearchResource`]((https://github.com/Graphity/graphity-browser/blob/master/src/main/java/org/graphity/browser/SearchResource.java)): JAX-RS Resource for search/autocomplete (_unfinished_)
