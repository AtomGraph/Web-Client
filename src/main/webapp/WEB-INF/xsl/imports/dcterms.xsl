...
<!DOCTYPE xsl:stylesheet [
    ...
    <!ENTITY ont-uri "../../owl/dcterms.rdf">
]>
...
exclude-result-prefixes="url g rdf rdfs">
    ...
    <xsl:template match="@rdf:about[starts-with(., '&dct;')] | @rdf:resource[starts-with(., '&dct;')]"  mode="g:label">
    ...
    <!-- rdfs:* property -->
    <xsl:template match="*[@rdf:about or @rdf:nodeID]/dct:*" mode="g:label">
