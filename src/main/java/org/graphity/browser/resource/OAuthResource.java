...
public class OAuthResource // implements ClientFilter
{
    ...
    // is @Context necessary here???
    private @Context UriInfo uriInfo = null;
    private @QueryParam(CODE) String authCode = null;
    private @QueryParam("error") String error = null;
    private @QueryParam("error_reason") String reason = null;
