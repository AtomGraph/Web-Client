...
import org.graphity.processor.provider.CacheControlProvider;
...
import org.graphity.processor.provider.QueryProvider;
import org.graphity.processor.provider.SPARQLEndpointProvider;
import org.graphity.processor.provider.UpdateBuilderProvider;
import org.graphity.processor.provider.UpdateRequestProvider;
...
public class ApplicationBase extends org.graphity.server.ApplicationBase
{
	...
	singletons.add(new UpdateRequestProvider());
        singletons.add(new QueryBuilderProvider());
	singletons.add(new UpdateBuilderProvider());
	singletons.add(new CacheControlProvider());
